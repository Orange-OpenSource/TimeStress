...
class Wikidata(LinkPredictionDataset):
    """
    Wikidata triples

    This dataset contains knowledge base relation triples and textual mentions
    ...
    def download(self, overwrite=False):
        ...
        if download:
            archive_path = download_url(
                self.dataset_url, self.output_directory, overwrite
            )
